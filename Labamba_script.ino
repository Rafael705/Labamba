...
void loop()
{
  ...
  roda.setSpeed(255); //Define a velocidade maxima
  roda.run(FORWARD); //Gira o motor sentido horario
 
  delay(3000);
  roda.setSpeed(0);
  roda.run(RELEASE); //Desliga o motor
 
  delay(3000);
  roda.setSpeed(255);
  roda.run(BACKWARD); //Gira o motor sentido anti-horario
